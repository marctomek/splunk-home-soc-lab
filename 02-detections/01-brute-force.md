...
- [x] Screenshot: <img width="877" height="577" alt="screenshots:02-bruteforce-hydra" src="https://github.com/user-attachments/assets/ff988bad-5394-4f99-a210-51593faa419f" />— Hydra output confirming the cracked credential
- [x] Screenshot: <img width="1470" height="956" alt="screenshots:03-bruteforce-authlog" src="https://github.com/user-attachments/assets/5452f5da-7b97-4db1-b358-b2ea785e9b4e" /> — target-side auth.log showing failed attempts and the accepted login
- [x] Screenshot: <img width="1228" height="710" alt="screenshots:04-bruteforce-splunk-live" src="https://github.com/user-attachments/assets/598b7de3-c074-4f6b-94c0-3378b68bf860" /> — same attack rerun after syslog forwarding was fixed, showing the failed/accepted login events live in Splunk via SPL
